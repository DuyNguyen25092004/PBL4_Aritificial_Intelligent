"""Resume training from checkpoint for PyTorch models
"""
...
if __name__ == "__main__":
    """Main function to resume training of PyTorch models from checkpoint."""
    ...
    checkpoint_path = os.path.join(os.getcwd(), "checkpoints", f"{args.model}_weights.pt")
