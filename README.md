...
```bash
git clone https://github.com/DuyNguyen25092004/PBL4_Aritificial_Intelligent.git
cd PBL4_Aritificial_Intelligent
...
- Python 3.7+
- TensorFlow 2.x
- NumPy, SciPy, scikit-learn, matplotlib, wfdb
...
├── data/
│   ├── ptb/                    # PTB-XL gốc
│   └── ptb_reconstructed/      # Dữ liệu tái tạo từ RESCNN
├── models/
│   ├── imle_net.py             # Kiến trúc IMLE-Net
│   └── rescnn.py               # Kiến trúc RESCNN
├── notebooks/
│   ├── IMLE_NET_TRAIN_PTB_XL.ipynb
│   └── IMLE_NET_TRAIN_RECONSTRUCTED.ipynb
├── preprocessing/
│   ├── preprocess_ptbxl.py
│   └── reconstruct.py
├── utils/
...
├── results/                    # Attention visualizations
├── images/
│   ├── eda.png
│   └── attention_viz.png
├── train.py
